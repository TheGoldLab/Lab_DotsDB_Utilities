...
def write_stimulus_to_file(stim, num_of_trials, filename, create_file=True, append_to_group=False,
    ...
    """
    Write the stimulus generated by a :class:`DotsStimulus` instance to HDF5 file. A pre-generated stimulus may be used
    instead. A specific group in the file is created, with group name generated by :func:`build_group_name`.
