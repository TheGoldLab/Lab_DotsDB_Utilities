...
def write_stimulus_to_file(stim, num_of_trials, filename, create_file=True, hold_stim_in_mem=True,
    ...
    """
    Write the stimulus contained in a :class:`DotsStimulus` instance to HDF5 file.
    ...
    :param hold_stim_in_mem: if true, generates stimulus on the fly (and holds it in memory) before writing it to file \
     (default=True)
    :type hold_stim_in_mem: bool
