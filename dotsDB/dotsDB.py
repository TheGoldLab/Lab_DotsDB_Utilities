...
def write_stimulus_to_file(stim, num_of_trials, filename, create_file=True, append_to_group=False,
                           pre_generated_stimulus=None, group_name=None, max_trials=None):
    """
    ...
    :type group_name: str
    :param max_trials: used to set max number of rows in HDF5 dataset. If None, size will be uncapped.
    :type max_trials: int
    :rtype: None
    """
    if create_file:
